...
const Contact = () => {
  return (
    <div name="contact" className="w-full h-screen bg-amber-100 text-yellow-900 flex justify-center items-center p-4">
        <form action="https://getform.io/f/d5f5d29c-1886-47c4-8032-59665fbbdb92" method="POST" className="flex flex-col max-w-[600px] w-full">
            ...
            <button className="text-amber-100 bg-yellow-900 border-2 border-yellow-900 rounded-lg hover:bg-green-700 hover:border-green-700 hover:scale-110 duration-300 px-4 py-3 my-8 mx-auto flex items-center">Let's Collaborate</button>
        </form>
    </div>
  )
}
